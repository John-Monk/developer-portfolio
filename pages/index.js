    ...
    <>
      <Head>
        ...
        <footer class={`container ${styles.footer}`}>
          <span className={styles.footer__span}>Designed by <a className={styles.footer__link} target="_blank" href="https://www.linkedin.com/in/john-monk/">John Monk</a> | <a className={`${styles.footer__link} ${styles.footer__github}`} target="_blank" href="https://github.com/John-Monk/developer-portfolio">View Code</a></span>
        </footer>
    </>
  )
}
